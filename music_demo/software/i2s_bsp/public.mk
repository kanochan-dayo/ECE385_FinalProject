...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../rhythm_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is rhythm_soc
SOPC_NAME := rhythm_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x411128
SOPC_SYSID_FLAG += --sidp=0x411128
ELF_PATCH_FLAG  += --sidp 0x411128

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1669668837
SOPC_SYSID_FLAG += --timestamp=1669668837
ELF_PATCH_FLAG  += --timestamp 1669668837
